...
container restarts. When a client sends an unknown session ID,
instead of returning 404, we create a new transport paired with
that session ID so the client can re-initialize transparently.
"""
