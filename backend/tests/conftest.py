...
from app.models import AgentRelease, AllowedEmail, Bookmark, BookmarkCollection, ChatMessage, ChatSession, DocPage, DocSite, DocumentVersion, Knowledge, McpApiFeedback, McpApiKey, McpToolCallEvent, McpToolUsageBucket, Project, ProjectDocument, ProjectSecret, RemoteAgent, RemoteExecLog, SecretAccessLog, Task, User
...
_ALL_MODELS = [User, AllowedEmail, Project, Task, McpApiKey, McpToolUsageBucket, McpToolCallEvent, McpApiFeedback, Knowledge, ProjectDocument, DocumentVersion, DocSite, DocPage, Bookmark, BookmarkCollection, RemoteAgent, RemoteExecLog, AgentRelease, ChatSession, ChatMessage, ProjectSecret, SecretAccessLog]
