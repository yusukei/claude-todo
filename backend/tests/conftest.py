...
def test_app(_setup_infra):
    ...
    from app.api.v1.endpoints import attachments, auth, backup, bookmark_assets, bookmarks, docsites, documents, events, install_public, knowledge, mcp_keys, mcp_usage, projects, secrets, task_live, tasks, users, workbench_layouts, workspaces
    ...
    # install_public is mounted at app root in production main.py — same here.
