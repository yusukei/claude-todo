...
from app.models import AgentRelease, AllowedEmail, Bookmark, BookmarkCollection, DocPage, DocSite, DocumentVersion, ErrorAuditLog, ErrorIssue, ErrorTrackingConfig, ErrorRelease, Knowledge, McpApiFeedback, McpApiKey, McpToolCallEvent, McpToolUsageBucket, Project, ProjectDocument, ProjectSecret, RemoteAgent, RemoteExecLog, SecretAccessLog, Task, User, WorkbenchLayout
...
_ALL_MODELS = [User, AllowedEmail, Project, Task, McpApiKey, McpToolUsageBucket, McpToolCallEvent, McpApiFeedback, Knowledge, ProjectDocument, DocumentVersion, DocSite, DocPage, Bookmark, BookmarkCollection, RemoteAgent, RemoteExecLog, AgentRelease, ProjectSecret, SecretAccessLog, ErrorTrackingConfig, ErrorIssue, ErrorRelease, ErrorAuditLog, WorkbenchLayout]
...
def test_app(_setup_infra):
    ...
    from app.api.v1.endpoints import attachments, auth, backup, bookmark_assets, bookmarks, docsites, documents, events, knowledge, mcp_keys, mcp_usage, projects, secrets, task_live, tasks, users, workbench_layouts, workspaces
